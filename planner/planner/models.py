...
class Invitations(StandardInfo):
    quantity = models.PositiveIntigerField()
...
class AdditionalServices(StandardInfo):
    importance = models.IntigerField(max_length = 10)

class WeddingHall(StandardInfo):
    accomodation = models.BooleanField()
    guest_capacity = models.PositiveIntigerField()
...
class Guest(models.Model):
    ...
    accomodation = models.BooleanField()
    age = models.IntigerField(max_length = 3)
